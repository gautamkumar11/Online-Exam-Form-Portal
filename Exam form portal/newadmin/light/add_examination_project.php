...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  if(isset($_POST['submit']))
  {
        ...
        $query="select * from examination where college_id='$college_id' AND session_id='$session_id' AND exam_name='$exam_name'";
        $get_data = mysqli_query($conn,$query);
        //$data= mysqli_fetch_array($get_data);
        $rowcount=mysqli_num_rows($get_data);
        if($rowcount>=1){
          echo '<script language="javascript">';
          echo 'alert("exam_name already exist")';
          echo '</script>';
        }else{
			mysqli_query($conn,"insert into examination(exam_name,session_id,semester_id,college_id) values('".$_POST['exam_name']."','$session_id','$semester_id','$college_id')");
		
                echo '<script language="javascript">';
                echo 'alert("exam_name has been registered succefully")';
                echo '</script>';
              }
  }
}
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Examination</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <form action="" method="POST" id="" class="form-horizontal">
                                        <div class="form-body">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="exam_name" placeholder="enter examinamtion name" class="form-control input-height"  onkeyup="this.value = this.value.toUpperCase();" required/> </div>
                                            </div>
											<?php
