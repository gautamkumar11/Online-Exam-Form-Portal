...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  if(isset($_POST['submit']))
  {
        ...
        $query="select session from session where college_id= '$college_id'";
        $get_data = mysqli_query($conn,$query);
        $data= mysqli_fetch_array($get_data);
        //$rowcount=mysqli_num_rows($get_data);
        if($data['session']==$s && $data['college_id']=$college_id){
          echo '<script language="javascript">';
          echo 'alert("Session already exist")';
          echo '</script>';
        }else{
			mysqli_query($conn,"insert into session(session,college_id) values('".$_POST['session']."','$college_id')");
		
                echo '<script language="javascript">';
                echo 'alert("Session has been registered succefully")';
                echo '</script>';
              }
  }
}
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Session Registration</header>
                                    ...
                                    <form action="" method="POST" id="" class="form-horizontal">
                                        <div class="form-body">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="session" placeholder="enter Session" class="form-control input-height" required/> </div>
                                            </div>
											...
											<div class="form-actions">
											 <div class="row">
                                                ...
                                                <input type="button" value="cancel" class="btn" onClick="document.location.href='http://localhost/newadmin/light/all_session_project.php';" />
                                                </div>
                                             </div>
                                       		</div>
										</div>
