...
$ds_name= $_POST['department_short_name'];
$d_id= $_POST['department_hod_email'];
$hod_name= $_POST['department_hod_name'];
$mo_no= $_POST['department_mobile_number'];
$start_date=$_POST['department_start_date'];
$s_capacity=$_POST['student_capacity'];
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  if(isset($_POST['update']))
  {
				...
				mysqli_query($conn,"UPDATE department set department_name='$d_name',department_short_name='$ds_name',department_hod_email='$d_id',department_hod_name='$hod_name',department_mobile_number='$mo_no',department_start_date='$start_date',student_capacity='$s_capacity' where id=".$_GET['edit']);
			
                echo '<script language="javascript">';
                echo 'alert("department has been update succefully")';
                echo '</script>';
  }
}

$getdata=mysqli_query($conn,"select * from department where id= ".$_GET['edit']);
                                    ...
                                    <form method="POST" action="" id="" class="form-horizontal">
                                        <div class="form-body">
	                                        <div class="form-group row">
	                                             ...
	                                             <div class="col-md-5">
	                                                 <input type="text" name="department_name" placeholder="enter department name" class="form-control input-height" value="<?php echo $data1['department_name'] ?>" required/> </div>
	                                        </div>
											<div class="form-group row">
	                                             ...
	                                             <div class="col-md-5">
	                                                 <input type="text" name="department_short_name" placeholder="enter department short name" class="form-control input-height" value="<?php echo $data1['department_short_name'] ?>"required /> </div>
	                                        </div>
											<div class="form-group row">
	                                             <label class="control-label col-md-3">Department HOD Email
	                                             </label>
	                                             <div class="col-md-5">
	                                                 <input type="email" name="department_hod_email" placeholder="enter Department contact number" value="<?php echo $data1['department_hod_email'] ?>"  class="form-control input-height" /> </div>
	                                         </div>
											<div class="form-group row">
	                                             <label class="control-label col-md-3">Head Of Department
	                                             </label>
	                                             <div class="col-md-5">
	                                                 <input type="text" name="department_hod_name" placeholder="enter HOD name" class="form-control input-height" value="<?php echo $data1['department_hod_name'] ?>"/> </div>
	                                         </div>
											 <div class="form-group row">
	                                             <label class="control-label col-md-3">Department Contact
	                                             </label>
	                                             <div class="col-md-5">
	                                                 <input type="text" name="department_mobile_number" placeholder="enter Department contact number" value="<?php echo $data1['department_mobile_number'] ?>"  class="form-control input-height" /> </div>
	                                         </div>
	                                         <div class="form-group row">
                                                <label class="control-label col-md-3">Department Start Date
	                                                ...
	                                                <div class="col-md-5">
			                                                ...
			                                                <input class="form-control input-height" size="16" placeholder="department start date" name="department_start_date" type="text" value="<?php echo $data1['department_start_date'] ?>" id= "date">
                                            ...
                                            <div class="form-group row">
	                                             ...
	                                             <div class="col-md-5">
	                                                 <input type="text" name="student_capacity" placeholder="enter student capacity"  value="<?php echo $data1['student_capacity'] ?>" class="form-control input-height" /> </div>
	                                         </div>	
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <input type="button" value="cancel" class="btn" onClick="document.location.href='http://localhost/newadmin/light/all_department_project.php';" />
                                                </div>
                                             </div>
                                       		 </div>
										</div>
