...
if(isset($_GET['delete']))
	{
		mysqli_query($conn,"delete from student_registration where id= ".$_GET['delete']);
	}
?>
<!DOCTYPE html>
<html lang="en">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_student_project.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
															...
															<?php
																...
																error_reporting(1);
																$i=0;
																//SELECT * FROM `student_registration` as A inner join admin_registration as B on A.college_id = B.id where `college_id`='17'
																
																$query1="SELECT * FROM `student_registration` where `college_id`='$college_id'";
														...
														?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $data['department'] ?></td>
																	<td class="left"><?php echo $data['semester'] ?></td>
																	<td class="left"><?php echo $data['session'] ?></td>
																	<td><a href="tel:<?php echo $data['mobile'] ?>">
																			<?php echo $data['mobile'] ?></a></td>
																	<td><a href="mailto:<?php echo $data['email'] ?>">
																			<?php echo $data['email'] ?> </a></td>
																	<td class="left"><?php echo $data['registration_date'] ?></td>
																	<td>
																		<a href="edit_student_project.php?edit=<?php echo $data['id'];?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="all_students_project.php?delete=<?php echo $data['id'];?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o "></i> </a>
