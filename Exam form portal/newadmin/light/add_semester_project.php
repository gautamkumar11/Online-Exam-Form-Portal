...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  if(isset($_POST['submit']))
  {
        ...
        $query="select semester_name from semester where college_id= '$college_id'";
        $get_data = mysqli_query($conn,$query);
        $data= mysqli_fetch_array($get_data);
        //$rowcount=mysqli_num_rows($get_data);
        if($data['semester_name']==$semester_name && $data['college_id']=$college_id){
          echo '<script language="javascript">';
          echo 'alert("semester_name already exist")';
          echo '</script>';
        }else{
			mysqli_query($conn,"insert into semester(semester_name,term,college_id) values('".$_POST['semester_name']."','".$_POST['term']."','$college_id')");
		
			
                echo '<script language="javascript">';
                echo 'alert("Semester has been registered succefully")';
                echo '</script>';
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Semester Registration</header>
                                    ...
                                    <form action="" method="POST" id="" class="form-horizontal">
                                        <div class="form-body">
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="semester_name" placeholder="enter semester" class="form-control input-height" required> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="term" placeholder="enter your term" class="form-control input-height" required/> </div>
                                            </div>
