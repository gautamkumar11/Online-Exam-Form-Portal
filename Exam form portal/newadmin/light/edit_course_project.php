...
$cs_name= $_POST['course_short_name'];
$c_code= $_POST['course_code'];
$credit= $_POST['credit'];
$year=$_POST['year'];
$elective=$_POST['elective_status'];
...
$session=$_POST['session'];
	...
	$semester_name=$_POST['semester_name'];
		...
		$semester_id=$data12['id'];
				...
				mysqli_query($conn,"UPDATE course set course_name='$c_name',course_short_name='$cs_name',course_code='$c_code',credit='$credit',department_id='$department_id',semester_id='$semester_id',session_id='$session_id',year='$year',elective_status='$elective',course_type='$c_type'where id=".$_GET['edit']);
			
                echo '<script language="javascript">';
                echo 'alert("course has been update succefully")';
                echo '</script>';
  }
}

$getdata=mysqli_query($conn,"select * from course where id= ".$_GET['edit']);
$data1= mysqli_fetch_array($getdata);
	...
	$department_id2=$data1['department_id'];
		$query11="select department_name from department where college_id='$college_id' AND id='$department_id2'";
        $get_data11 = mysqli_query($conn,$query11);
        $data11= mysqli_fetch_array($get_data11);
		$department_name=$data11['department_name'];
		
	$semester_id2=$data1['semester_id'];
		$query12="select semester_name from semester where college_id='$college_id' AND id='$semester_id2'";
        $get_data12 = mysqli_query($conn,$query12);
        $data12= mysqli_fetch_array($get_data12);
                                    ...
                                    <form method="POST" action="" id="" class="form-horizontal">
                                        <div class="form-body">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="course_short_name" placeholder="enter course short name" class="form-control input-height"  value="<?php echo $data1['course_short_name'] ?>"required /> </div>
                                            </div>
                                            <div class="form-group row">
											...
											<div class="form-group row">
                                               ...
                                               <div class="col-md-5">
                                                    <input type="text" name="credit" placeholder="enter course credit" class="form-control input-height"  value="<?php echo $data1['credit'] ?>"required /> </div>
                                            </div>
											<?php
											$college_id= $_SESSION['admin_id'];
                                                ...
                                                <label class="control-label col-md-3">Semester
                                                 ...
                                                 <div class="col-md-5">
                                                    <select class="form-control input-height" name="semester_name" required>
                                                        <option><?php echo $semester_name?></option>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-control input-height" name="year" required >
                                                        <option><?php echo $data1['year'] ?></option>
                                                        <option>First</option>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-control input-height" name="elective_status"  value="<?php echo $data1['elective_status'] ?>" required>
                                                        <option><?php echo $data1['elective_status'] ?></option>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-control input-height" name="course_type"   required >
                                                        <option><?php echo $data1['course_type'] ?></option>
