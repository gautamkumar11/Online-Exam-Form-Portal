...
$college_id= $_SESSION['admin_id'];
error_reporting(1);
$department_name = $_POST['department_name']; echo $department_name;
$department_hod_email = $_POST['department_hod_email'];
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  if(isset($_POST['submit']))
  {
	  $query="select * from department where college_id='$college_id' AND (department_name='$department_name' OR department_short_name='$department_short_name')";
		...
		mysqli_query($conn,"insert into department(department_name,department_short_name,department_hod_email,department_hod_name,department_mobile_number,department_start_date,student_capacity,college_id)values('".$_POST['department_name']."','".$_POST['department_short_name']."','".$_POST['department_hod_email']."','".$_POST['department_hod_name']."','".$_POST['department_mobile_number']."','".$_POST['department_start_date']."','".$_POST['student_capacity']."','$college_id')"); 
			
			
                echo '<script language="javascript">';
                echo 'alert("department has been registered succefully")';
                echo '</script>';
              } 
  }
}
                                    ...
                                    <form action="" method="POST" id="" class="form-horizontal">
                                        <div class="form-body">
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="department_name" placeholder="enter name of department" class="form-control input-height" required> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="department_short_name" placeholder="enter short name of department" class="form-control input-height" required/> </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="email" name="department_hod_email" placeholder="enter Department HOD Email" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="department_hod_name" placeholder="enter name of Head of Department" class="form-control input-height" /> </div>
                                            </div>
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="department_mobile_number" placeholder="enter Department Contact" class="form-control input-height"/> </div>
                                            </div>
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="department_start_date" placeholder="enter Department Start Date" class="form-control input-height" id="date"/> </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="student_capacity" placeholder="enter Student Capacity" class="form-control input-height" /> </div>
                                            </div>
