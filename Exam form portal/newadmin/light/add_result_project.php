...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  ...
  {
		echo $college_id= $_SESSION['admin_id']; 
		echo $semester_name=$_POST['semester_name'];
		echo $registration_id=$_POST['registration_id'];
	  
        $query5="select * from student_registration where college_id='$college_id' AND registration_id='$registration_id' AND semester= '$semester_name'";
        $get_data5 = mysqli_query($conn,$query5);
		 $data6= mysqli_fetch_array($get_data5); print_r($data6);
		$rowcount=mysqli_num_rows($get_data5);
		if($rowcount>=1)
		{
			header("Location:http://localhost/newadmin/light/add_result.php");
			$_SESSION['student_id'] = $data6['id'];
		...
		$_SESSION['$semester_id']=$data12['id']; */
  }
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  if(isset($_POST['submit']))
  {
		...
		$query12="select id from department where college_id='$college_id' AND department_name='$department_name'";
        $get_data12 = mysqli_query($conn,$query12);
        $data12= mysqli_fetch_array($get_data12);
		$_SESSION['$department_id']=$data12['id'];
		
		$session=$data6['session'];
		$query12="select id from session where college_id='$college_id' AND session='$session'";
        $get_data12 = mysqli_query($conn,$query12);
        $data12= mysqli_fetch_array($get_data12);
		$_SESSION['$session_id']=$data12['id']; */
?>				
                                    ...
                                    <form method="POST" action="" class="form-horizontal">
											...
											<div class="form-body">
													<div class="form-group row">
														...
														<div class="col-md-5">
															<input type="text" name="registration_id" placeholder="enter Student Registration ID" class="form-control input-height" required/> </div>
													</div>
												...
												<div class="form-actions">
													 <div class="row">
														<div class="offset-md-3 col-md-9">
															...
															<input type= "submit" id="submit_btn_id" name="submit" value="Submit" class="btn btn-info">
