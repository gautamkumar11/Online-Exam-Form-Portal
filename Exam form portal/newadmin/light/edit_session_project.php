...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 {
  ...
  {
        		mysqli_query($conn,"UPDATE session set session='$session' where id=".$_GET['edit']);
...
$getdata=mysqli_query($conn,"select * from session where id= ".$_GET['edit']);
                                    ...
                                    <form action="" method="POST" id="" class="form-horizontal">
                                        <div class="form-body">
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="session" placeholder="enter Session" class="form-control input-height" value="<?php echo $data1['session'] ?>" required/> </div>
                                            </div>
