...
if(isset($_GET['delete']))
	{
		mysqli_query($conn,"delete from course where id= ".$_GET['delete']);
	}
?>
<!DOCTYPE html>
<html lang="en">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_course_project.php" id="addRow" class="btn btn-info">
...
<?php
		...
		$query1="select * from course where college_id='$college_id'";
		$get_data1 = mysqli_query($conn,$query1);
		//$data= mysqli_fetch_array($get_data1);
		while ($data =  mysqli_fetch_array($get_data1))
		{									
		$session_id=$data['session_id']; 
		$query9="select session from session where college_id='$college_id' AND id='$session_id'";
        $get_data9 = mysqli_query($conn,$query9);
        $data9= mysqli_fetch_array($get_data9);
		$session=$data9['session'];
		
	$department_id=$data['department_id'];
		$query11="select department_name from department where college_id='$college_id' AND id='$department_id'";
	...
	$semester_id=$data['semester_id'];
		...
		$semester_name=$data12['semester_name'];
															...
															//	$rowcount=mysqli_num_rows($get_data1);
															//	print_r($data);
															//	echo $rowcount;
															//	$datas = array();
	...
	?>
																...
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $data['course_name'] ?></td>
																	
																	<td class="left"><?php echo $data['course_code'] ?></td>
																	<td class="left"><?php echo $data['credit'] ?></td>
																	<td class="left"><?php echo $department_name; ?></td>
																	<td class="left"><?php echo $semester_name; ?></td>
																	
																	<td class="left"><?php echo $session; ?></td>
																	<td class="left"><?php echo $data['course_type'] ?></td>
																	<td>
																		<a href="edit_course_project.php?edit=<?php echo $data['id'];?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="all_courses_project.php?delete=<?php echo $data['id'];?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o "></i> </a>
