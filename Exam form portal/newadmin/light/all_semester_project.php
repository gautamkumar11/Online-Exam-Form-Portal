...
if(isset($_GET['delete']))
	{
		mysqli_query($conn,"delete from semester where id= ".$_GET['delete']);
	}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All Semesters List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">All Semesters List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="row">
					                        <div class="col-md-12">
					                            <div class="card card-box">
					                                <div class="card-head">
					                                    <header>All Semesters List</header>
					                                    <div class="tools">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_semester_project.php" id="addRow" class="btn btn-info">
					                                                    Add New Semester<i class="fa fa-plus"></i>
					                                                </a>
					                                            </div>
					                                        </div>
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                    ...
					                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
															...
															<?php
																...
																$query1="select * from semester where college_id='$college_id'";
														...
														?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $data['semester_name'] ?></td>
																	<td class="left"><?php echo $data['term'] ?></td>
																	
																	<td>
																		<a href="edit_semester_project.php?edit=<?php echo $data['id'];?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																	</td>
																	<td>
																		<a href="all_semester_project.php?delete=<?php echo $data['id'];?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o "></i> </a>
