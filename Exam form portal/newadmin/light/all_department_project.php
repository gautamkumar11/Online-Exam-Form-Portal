...
if(isset($_GET['delete']))
	{
		mysqli_query($conn,"delete from department where id= ".$_GET['delete']);
	}
?>
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_department_project.php" id="addRow" class="btn btn-info">
														...
														error_reporting(1);
														$college_id=$_SESSION['admin_id'];
														$query1="select * from department where college_id='$college_id'";
														...
														?>
																...
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $data['department_name'] ?></td>
																	<td class="left"><?php echo $data['department_short_name'] ?></td>
																	<td><?php echo $data['department_hod_email'] ?></td>
																	<td class="left"><?php echo $data['department_hod_name'] ?> </td>
																	<td><a href="tel:7028870790">
																			<?php echo $data['department_mobile_number'] ?> </a></td>
																	
																	<td><?php echo $data['department_start_date'] ?></td>
																	
																	<td>
																		<a href="edit_department_project.php?edit=<?php echo $data['id'];?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="all_department_project.php?delete=<?php echo $data['id'];?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o "></i> </a>
