...
if(isset($_GET['delete']))
	{
		mysqli_query($conn,"delete from result where id= ".$_GET['delete']);
	}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All Results List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">All Results List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="row">
					                        <div class="col-md-12">
					                            <div class="card card-box">
					                                <div class="card-head">
					                                    <header>All Results List</header>
					                                    <div class="tools">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_result_project.php" id="addRow" class="btn btn-info">
					                                                    Add New Result<i class="fa fa-plus"></i>
					                                                </a>
					                                            </div>
					                                        </div>
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                    ...
					                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
															...
															<?php
																...
																error_reporting(1);
																$i=0;
																$query1="select * from result where college_id='$college_id'";
														...
														?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $data['registration_id'] ?></td>
																	<td class="left"><?php echo $data['total_mark'] ?></td>
																	<td class="left"><?php echo $data['cutoff_mark'] ?></td>
																	<td class="left"><?php echo $data['obtain_mark'] ?></td>
																	<td class="left"><?php echo $data['grade'] ?></td>
																	<td class="left"><?php echo $data['course_code'] ?></td>
																	<td class="left"><?php echo $data['num_of_attempt'] ?></td>
																	<td class="left"><?php echo $data['student_type'] ?></td>
																	<td>
																		<a href="edit_result_project.php?edit=<?php echo $data['id'];?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																	
																		<a href="all_result_project.php?delete=<?php echo $data['id'];?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o "></i> </a>
