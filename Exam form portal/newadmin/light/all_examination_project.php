...
if(isset($_GET['delete']))
	{
		mysqli_query($conn,"delete from examination where id= ".$_GET['delete']);
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<!DOCTYPE php>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All Examination</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">All Examination</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_examination_project.php" id="addRow" class="btn btn-info">
					                                                    Add New Examination<i class="fa fa-plus"></i>
					                                                </a>
					                                            </div>
					                                        </div>
					                                        <div class="col-md-6 col-sm-6 col-6">
		...
		<?php
			...
			$query1="select * from examination where college_id='$college_id'";
		...
		?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $data['exam_name'] ?></td>
																	<td class="left"><?php echo $data9['session'] ?></td>
																	<td class="left"><?php echo $data12['semester_name'] ?></td>
																	<td>
																		<a href="edit_examination_project.php?edit=<?php echo $data['id'];?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																	</td>
																	<td>
																		<a href="all_examination_project.php?delete=<?php echo $data['id'];?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o "></i> </a>
