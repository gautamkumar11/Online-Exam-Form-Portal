...
if(isset($_POST['submit']))
{
  ...
  $query="select * from registration where email='$e' or number='$n'";
  ...
  { 
    if($data['number']==$n)
    {
      echo "Email and number already used";
    }
    else
    {
  ...
  {
  mysqli_query($con,"insert into registration(fname,lname,email,pass,number)
  values('".$_POST['fname']."','".$_POST['lname']."','$e','".$_POST['pass']."','$n')");
