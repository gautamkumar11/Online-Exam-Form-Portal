...
{
  $squery1 = "SELECT admin_registration.college, student_information.registration_id, student_information.password from admin_registration INNER JOIN student_information ON admin_registration.college = student_information.college";
  $sgetdata1= mysqli_query($conn,$squery1);
  $sdata1= mysqli_fetch_array($sgetdata1);
  
  if($sdata1['college']==$x && $sdata1['registration_id']==$y && $sdata1['password']==$z)
    {
