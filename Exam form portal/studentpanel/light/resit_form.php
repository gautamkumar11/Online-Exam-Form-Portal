...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color">
    <div class="page-wrapper">
	                    ...
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <!--<ul class="sub-menu">
	                                ...
	                                <li class="nav-item">
	                                    <a href="edit_student_project.html" class="nav-link "> <span class="title">Edit Student</span>
	                                    </a>
	                                </li>
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item">
	                                    <a href="" class="nav-link "> <span class="title">Add Payment</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
		...
		<?php 
			if(isset($_POST['submit']))
			{
				...
				if(!empty($_POST['course_id']))
				{
					...
					foreach($_POST['course_id'] as $value){
						mysqli_query($conn,"insert into exam_form(student_id,student_type,course_id,reasons_for_unticked,form_filling_date,college_id) values('$student_id','$exstudent','".$value."','".$_POST['reasons_for_unticked']."','".$_POST['form_filling_date']."','$college_id')");
					...
					/*	echo '<script language="javascript">';
						...
						$regular="Regular";
						foreach($_POST['course_id'] as $value){
						mysqli_query($conn,"insert into exam_form(student_id,student_type,course_id,reasons_for_unticked,form_filling_date,college_id) values('$student_id','$regular','".$value."','".$_POST['reasons_for_unticked']."','".$_POST['form_filling_date']."','$college_id')");
						}
					}
				}	
			}
			...
			$query11="select * from result_csv_table where college_id='$college_id' AND session='$session'AND registration_id='$registration_id' AND semester_name='$semsester'";
			$get_data11 = mysqli_query($conn,$query1);
			$data11= mysqli_fetch_array($get_data11);
			$rowcount11=mysqli_num_rows($get_data11);
											...
											<div class="container">
												...
												<table class="table table-hover table-bordered" style="width:100%;">
													...
													<tbody>
														<?php
														$i=0;
														$query2="select * from course INNER JOIN result_csv_table where result_csv_table.course_code=course.course_code AND result_csv_table.grade='F' AND course.semester_id='$semsester_id' AND course.department_id='$department_id' AND course.college_id='$college_id'";
