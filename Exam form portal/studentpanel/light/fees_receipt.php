...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/fees_receipt.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Aug 2018 12:21:21 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <div class="page-wrapper">
                        ...
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"> Pooja </span>
        ...
        <!--<div class="quick-setting-main">
			...
			<div class="quick-setting display-none">
				...
				<a href="http://radixtouch.in/templates/admin/smart/source/dark/fees_receipt.html" data-theme="dark"><span class="head"></span><span class="cont"></span></a>
				</div></li>	
	                    ...
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                       ...
	                       <!-- <li class="nav-item">
	                        ...
	                        <li class="nav-item active open">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item">
	                                    <a href="fees_collection.html" class="nav-link "> <span class="title">Add Fees </span>
	                                    </a>
	                                </li>
	                                <!--<li class="nav-item">
...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/fees_receipt.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Aug 2018 12:21:22 GMT -->
</html>