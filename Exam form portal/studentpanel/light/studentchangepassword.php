...
if(!isset($_SESSION['student_id']))
{
	...
	{
		 $query="select password from student_registration where id='$student_id'";
		...
		if($data['password']==$op)
				{
					...
					{
					mysqli_query($conn,"UPDATE student_registration SET password='$np' where id='$student_id'");
                                    ...
                                    <form id="loginform" class="form-horizontal" role="form" role="form" method="POST" action="">
											...
											<div class="form-actions">
											 <div class="row">
												...
												<input type="button" value="cancel" class="btn" onClick="document.location.href='http://localhost/studentpanel/light/index.php';" />
											  </div>
											</div>
										   </div> 
								</form>
